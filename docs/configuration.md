...
FM_NM_STALL_ACTIVE_SECS=900   # seconds before a matching running/fixing no-mistakes step without a transition or crew-status write wakes its owning supervisor; invalid values use 900
FM_NM_STALL_PARKED_SECS=480   # seconds before a matching awaiting_approval/fix_review no-mistakes gate wakes its owning supervisor; invalid values use 480

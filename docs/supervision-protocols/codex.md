...
4. Ordinary wake: if the command prints `signal:`, `stale:`, `check:`, `heartbeat`, `supervision:`, or `deadline:`, drain queued wakes, handle that wake, then start the next checkpoint.
